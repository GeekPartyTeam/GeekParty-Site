...
class WorkAuthorController extends Controller
{
     ...
     *
     * @Route("/{id}/show", name="admin_workauthor_show")
     * @Template()
     */
     ...
     *
     * @Route("/new", name="admin_workauthor_new")
     * @Template()
     */
     ...
     *
     * @Route("/create", name="admin_workauthor_create")
     * @Method("POST")
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_workauthor_show', array('id' => $entity->getId())));
        }
     ...
     *
     * @Route("/{id}/edit", name="admin_workauthor_edit")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/update", name="admin_workauthor_update")
     * @Method("POST")
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_workauthor_edit', array('id' => $id)));
        }
     ...
     *
     * @Route("/{id}/delete", name="admin_workauthor_delete")
     * @Method("POST")
     */
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_workauthor'));
    }
